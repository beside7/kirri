...
export const SelectProfileImage = ({
    ...
    const [selected, setSelected] = React.useState<ProfileImageTypes>(
        selectedImage as ProfileImageTypes
    );
    ...
    return (
        <ProfileImageContainer>
            <SelectedWarp>
                <SelectedImageContainer>
                    <SelectedImage source={ProfileImages[selected]} />
                </SelectedImageContainer>
            </SelectedWarp>
            <ProfileImageWarp>
                <ImageLisContainer>
                    {Object.keys(ProfileImages).map((key, index) => (
                        ...
                        >
                            ...
                            {key === selected ? (
                                <SelectedCheck>
                                    <Image source={SelecedCheckImage} />
                                </SelectedCheck>
                            ) : (
                                <></>
                            )}
